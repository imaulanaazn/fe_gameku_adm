...
export default function RootLayout({ children }: { children: React.ReactNode }) {
    ...
    const getMe = async () => {
        ...
        if (req.ok) {
            ...
            if (pathname === (process.env.NODE_ENV === "production" ? "/admin/auth/login" : "/admin/auth/login")) {
            ...
            router.replace(process.env.NODE_ENV === "production" ? "/admin/auth/login" : "/admin/auth/login");
            return false;
        }
    };
            ...
            <body className="overflow-y-hidden">
                <RecoilRoot>
                    ...
                    <div className="flex w-full text-sm">
                        ...
                        <div
                            className={`w-full ${
                                pathname !== "/admin/auth/login" && "p-4"
                            } bg-gray-100 overflow-y-scroll h-screen`}
                        >
                            {children}
                        </div>
                    </div>
