  ...
  return (
    ...
    >
      <div className="mx-auto text-center w-full h-full lg:h-max flex items-center lg:items-stretch justify-center overflow-hidden">
        <div className="left-side bg-white w-96 md:w-[25rem] lg:w-96 xl:w-[30rem] h-full md:h-max lg:h-[30rem] xl:h-[40rem] overflow-scroll px-10 py-10 xl:px-16 xl:py-16 flex flex-col">
