...
const Xendit = () => {
    ...
    useEffect(() => {
        ...
        setValue({
            api: isDisabled.api ? defaultValue : value.api === defaultValue ? "" : value.api,
            webhook: isDisabled.webhook ? defaultValue : value.webhook === defaultValue ? "" : value.webhook,
        });
                        ...
                        <th scope="row" className="py-4 font-medium text-gray-900 whitespace-nowrap text-start">
                            <input
                                ...
                                className={`border rounded px-3 py-2 w-full focus:outline-none focus:border-blue-500 ${
                                    !isDisabled["api"] ? "border-blue-500" : "border-transparent"
                                }`}
                            />
                        </th>
                        <th scope="row" className="py-4 font-medium text-gray-900 whitespace-nowrap text-start">
                            <div
                                className="font-montserrat font-bold text-blue-800 cursor-pointer select-none w-fit"
                    ...
                    <tr>
                        ...
                        <th scope="row" className="py-4 font-medium text-gray-900 whitespace-nowrap text-start">
                            <input
                                ...
                                className={`border rounded px-3 py-2 w-full focus:outline-none focus:border-blue-500 ${
                                    !isDisabled["webhook"] ? "border-blue-500" : "border-transparent"
                                }`}
                            />
                        </th>
                        <th scope="row" className="py-4 font-medium text-gray-900 whitespace-nowrap text-start">
            ...
            {showButton && (
                <div className="w-full flex justify-end gap-5 mt-5">
                    ...
                    <button
                        ...
                        className="px-5 py-3 bg-gray-300 hover:bg-gray-100 rounded-md shadow-mde"
                    >
                        Cancel
                    </button>
                </div>
