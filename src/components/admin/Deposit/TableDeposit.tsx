...
const TableDeposit: React.FC<{ data: IOrderWithAnalitycsPaginationWithDetail }> = ({ data }) => {
    ...
    const getNewData = async () => {
        ...
        const req = await fetch(process.env.NEXT_PUBLIC_BASE_URL + "/v1/deposits?" + searchParams.toString(), {
            cache: "no-cache",
            method: "GET",
            credentials: "include",
            headers: {
    ...
    const handleChangeDeposit = async (data: any, approve: boolean) => {
        ...
        const req = await fetch(process.env.NEXT_PUBLIC_BASE_URL + "/v1/approval-deposit", {
            cache: "no-cache",
            method: "POST",
            credentials: "include",
            headers: {
                                                        ...
                                                        <td className="px-6 py-4 text-sm font-medium text-right">
                                                            {data.status === "3" || data.status === "4" ? (
                                                                <div className="flex justify-end w-full">
                                                                    <div className="bg-gray-600 px-4 py-2 rounded-md text-white cursor-not-allowed">
                                                                        Approve
                                                                    </div>
                                                                    <div className="bg-gray-600 px-4 py-2 rounded-md text-white cursor-not-allowed">
                                                                        Reject
