    ...
    if (!haveData && orderHistory.keySearch) {
        return (
            <div className="w-full bg-white mt-5 max-w-lg rounded-lg  py-10">
                <h1 className="text-slate-600 text-xl font-bold">Tidak Ada Transaksi</h1>
                <p className="text-gray-600 text-sm">Silahkan Periksa kembali No. Transaksi atau No. Whatsapp</p>
            </div>
        );
    } else if (haveData) {
        return (
            <div className="w-full bg-white mt-5 rounded-lg p-3">
                <h1 className="text-black text-base font-bold mb-5">Riwayat Transaksi</h1>
                ...
                <div className="flex justify-center text-black items-center gap-3">
                    <div
                        ...
                        className={`${
                            disablePrevious ? "bg-slate-400 cursor-not-allowed" : "bg-slate-300 cursor-pointer"
                    ...
                    <div
                        ...
                        className={`${
                            disableContinues ? "bg-slate-400 cursor-not-allowed" : "bg-slate-300 cursor-pointer"
                        } w-7 h-7 flex justify-center items-center rounded-md`}
                    >
