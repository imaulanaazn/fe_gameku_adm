...
function Unauthorized({ redirect }: { redirect: string }) {
  return (
    <section className="bg-white flex items-center justify-center">
      <div className="container min-h-screen px-6 md:px-12 py-12 mx-auto flex flex-col items-center justify-center lg:flex-row lg:items-center lg:gap-12">
        <div className="w-full lg:w-1/2">
          <p className="text-sm font-medium text-primary-900 ">401 error</p>
          <h1 className="mt-3 text-2xl font-semibold text-gray-800  md:text-3xl">
            Anda Tidak Memiliki Izin
          </h1>
          <p className="mt-4 text-gray-500 ">
            Mohon maaf, anda tidak memiliki izin untuk mengakses halaman ini,
            silahkan gunakan akun lain untuk melanjutkan
          </p>
...
export const generateMetadata = () => {
  return {
    title: "Tidak memiliki izin akses",
  } as Metadata;
};
