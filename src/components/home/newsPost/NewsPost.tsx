        ...
        <div className="py-20 bg-white mx-auto">
            <div className="container mx-auto sm:px-0 px-5">
                <div className="flex flex-col items-center gap-3 text-center">
                    <p className="font-montserrat font-light text-xs tracking-widest">TAKE A LOOK</p>
                    <h1 className="font-pulse font-semibold text-3xl">Event and News</h1>
                ...
                <div className="mx-auto pt-10 text-center">
                    <Link href="/posts" className="text-[#B72025] font-pulse font-bold hover:text-[#d46b6f]">
                        Read more...
                    </Link>
                </div>
            </div>
