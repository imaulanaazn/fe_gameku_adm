interface IDetailAccountProps {
    handleUserID: (userID: string) => void;
    handleServerID: (serverID: string) => void;
}

const DetailAccount: React.FC<IDetailAccountProps> = ({ handleServerID, handleUserID }) => {
    return (
        <div className="bg-slate-200 shadow-md rounded-lg p-7 mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3  gap-4 mt-5">
                ...
                <div className="flex flex-col">
                    <label className=" text-sm" htmlFor="serverID">
                        Server ID
                    </label>
                    <input
