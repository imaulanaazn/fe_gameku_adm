...
const ConfirmCheckout = ({ isOpen, onClose, dataCheckout, balance }: ConfirmCheckout) => {
    ...
    const requestCheckout = async () => {
        ...
        if (req.ok) {
            setMsg(dataCheckout.paymentMethod.cd === "GASSKEUN" ? "Orderan berhasil dibayar" : "Order Berhasil dibuat");
            setIsSuccess(true);
            setWaiting(false);
                        ...
                        <CardContent sx={{ marginTop: 2 }}>
                            ...
                            >
                                <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
                                    <Avatar src={dataCheckout.products.logoUrl} variant="rounded" />
                                ...
                                <Typography>{currencyConverter(dataCheckout.product.price)}</Typography>
                            </Box>
                            ...
                            <Button
                                ...
                                disabled={dataCheckout.paymentMethod.cd === "GASSKEUN" && balance < totalCheckout}
                            >
                                {dataCheckout.paymentMethod.cd === "GASSKEUN" ? "Bayar Sekarang" : "Beli Sekarang"}
                            </Button>
                        </CardContent>
                    </>
                ) : step === 2 ? (
