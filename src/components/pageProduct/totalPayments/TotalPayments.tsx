...
const TotalPayments = () => {
    ...
    const [formatPricesAfterDiscount, setFormatPricesAfterDiscount] = useState("Rp. 0");
    const [formatPricesBeforeDiscount, setFormatPricesBeforeDiscount] = useState("Rp. 0");
                        ...
                        {cart.pricesAfterDiscount === 0 ? (
                            ...
                            <>
                                <div className="relative w-fit">
                                    <p className="font-bold text-sm text-gray-500">{formatPricesBeforeDiscount}</p>
                                    <div className="absolute w-full h-px bg-gray-500 top-1/2"></div>
                                </div>
                                <p className="font-extrabold text-xl">{formatPricesAfterDiscount}</p>
                            </>
                        )}
                    </>
                ) : (
                    <p className="font-extrabold lg:text-base text-sm">Pilih Denom yang kamu inginkan sekarang!</p>
                )}
            </div>
            {loading ? (
