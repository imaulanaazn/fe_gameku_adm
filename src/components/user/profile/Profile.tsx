...
import Loading from "@/components/user/home/loading";
...
const Profile = () => {
  ...
  return (
    <>
      ...
      {user && !loading && (
        <div className="mx-auto pt-10 h-fit min-h-screen text-center w-full lg:p-5  text-white flex flex-col items-center">
          <div className="flex items-center gap-3 mb-10 justify-between w-3/4 lg:flex-row flex-col">
            ...
            <div
              className="bg-[#B72025] px-4 py-2 rounded-sm cursor-pointer"
